...
import ru.otus.spring.homeworks.ticketpro.dtos.seats.SeatInfo;
...
import ru.otus.spring.homeworks.ticketpro.repositories.SeatRepository;
...
public class SeatServiceImpl implements SeatService {
    ...
    public Seat getSeatByAircraftRowPositionChecked(Aircraft aircraft, Integer seatRow, Character seatPosition) {
        return seatRepository.getSeatByAircraftAndRowAndPosition(aircraft, seatRow, seatPosition).orElseThrow(() ->
                new CommonValidationException(
                        ErrorMessages.SEAT_NOT_FOUND_BY_ROW_POSITION.getCode(),
                        ErrorMessages.SEAT_NOT_FOUND_BY_ROW_POSITION.getMessage()
    ...
    public SeatSearchResponse findSeats(SeatSearchRequest request) {
        ...
        String jpaQuery =
                """
                        SELECT NEW ru.otus.spring.homeworks.ticketpro.dtos.seats.SeatInfo (
                            seat.location,
